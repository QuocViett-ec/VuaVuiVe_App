...
abstract class Hilt_OrderListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_OrderListFragment() {
    super();
  }

  Hilt_OrderListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OrderListFragment_GeneratedInjector) this.generatedComponent()).injectOrderListFragment(UnsafeCasts.<OrderListFragment>unsafeCast(this));
    }
  }
