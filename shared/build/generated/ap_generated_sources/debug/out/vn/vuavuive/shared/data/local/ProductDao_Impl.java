...
public final class ProductDao_Impl implements ProductDao {
  ...
  public ProductDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfProductEntity = new EntityInsertionAdapter<ProductEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `products` (`id`,`name`,`slug`,`price`,`originalPrice`,`category`,`subCategory`,`description`,`imageUrl`,`stock`,`unit`,`isActive`,`rating`,`reviewCount`,`soldCount`,`createdAt`,`cachedAt`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        if (entity.getSoldCount() == null) {
          ...
          statement.bindLong(15, entity.getSoldCount());
        }
    ...
    this.__preparedStmtOfDeleteExpiredCache = new SharedSQLiteStatement(__db) {
      ...
      @NonNull
      public String createQuery() {
        final String _query = "DELETE FROM products WHERE cachedAt < ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public void deleteExpiredCache(final long expiredBefore) {
    __db.assertNotSuspendingTransaction();
  ...
  public LiveData<List<ProductEntity>> getAllProducts() {
    final String _sql = "SELECT * FROM products WHERE isActive = 1 ORDER BY soldCount DESC";
    ...
    return __db.getInvalidationTracker().createLiveData(new String[] {"products"}, false, new Callable<List<ProductEntity>>() {
      ...
      public List<ProductEntity> call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfSoldCount = CursorUtil.getColumnIndexOrThrow(_cursor, "soldCount");
          ...
          while (_cursor.moveToNext()) {
            ...
            final Integer _tmpSoldCount;
            if (_cursor.isNull(_cursorIndexOfSoldCount)) {
              _tmpSoldCount = null;
            } else {
              _tmpSoldCount = _cursor.getInt(_cursorIndexOfSoldCount);
            }
            _item.setSoldCount(_tmpSoldCount);
  ...
  @Override
  public LiveData<List<ProductEntity>> getProductsByCategory(final String category) {
    final String _sql = "SELECT * FROM products WHERE category = ? AND isActive = 1 ORDER BY soldCount DESC";
  ...
  @Override
  public LiveData<List<ProductEntity>> searchProducts(final String query) {
    final String _sql = "SELECT * FROM products WHERE (name LIKE '%' || ? || '%' OR description LIKE '%' || ? || '%') AND isActive = 1";
  ...
  @Override
  public ProductEntity getProductSync(final String id) {
    ...
    try {
      ...
      if (_cursor.moveToFirst()) {
        ...
        _result.setSoldCount(_tmpSoldCount);
        final String _tmpCreatedAt;
        if (_cursor.isNull(_cursorIndexOfCreatedAt)) {
          _tmpCreatedAt = null;
        } else {
  ...
  @Override
  public LiveData<ProductEntity> getProduct(final String id) {
    final String _sql = "SELECT * FROM products WHERE id = ? LIMIT 1";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (id == null) {
  ...
  @Override
  public List<ProductEntity> getProductsSync() {
    final String _sql = "SELECT * FROM products WHERE isActive = 1 ORDER BY soldCount DESC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    __db.assertNotSuspendingTransaction();
    final Cursor _cursor = DBUtil.query(__db, _statement, false, null);
  ...
  public int getLowStockCount() {
    final String _sql = "SELECT COUNT(*) FROM products WHERE stock <= 5 AND isActive = 1";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    __db.assertNotSuspendingTransaction();
    final Cursor _cursor = DBUtil.query(__db, _statement, false, null);
    try {
