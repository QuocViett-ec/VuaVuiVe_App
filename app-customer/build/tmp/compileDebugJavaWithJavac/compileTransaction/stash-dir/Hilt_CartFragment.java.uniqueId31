...
abstract class Hilt_CartFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CartFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CartFragment_GeneratedInjector) this.generatedComponent()).injectCartFragment(UnsafeCasts.<CartFragment>unsafeCast(this));
    }
  }
