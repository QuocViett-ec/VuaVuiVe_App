...
abstract class Hilt_ShipperOrderListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ShipperOrderListFragment() {
    super();
  }

  Hilt_ShipperOrderListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ShipperOrderListFragment_GeneratedInjector) this.generatedComponent()).injectShipperOrderListFragment(UnsafeCasts.<ShipperOrderListFragment>unsafeCast(this));
    }
  }
