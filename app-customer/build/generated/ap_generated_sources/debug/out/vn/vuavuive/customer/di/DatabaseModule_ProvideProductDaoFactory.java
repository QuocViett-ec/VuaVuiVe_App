...
public final class DatabaseModule_ProvideProductDaoFactory implements Factory<ProductDao> {
  ...
  public DatabaseModule_ProvideProductDaoFactory(DatabaseModule module,
  ...
  public static DatabaseModule_ProvideProductDaoFactory create(DatabaseModule module,
      Provider<AppDatabase> databaseProvider) {
    return new DatabaseModule_ProvideProductDaoFactory(module, databaseProvider);
  }

  public static ProductDao provideProductDao(DatabaseModule instance, AppDatabase database) {
