...
public final class FragmentAccountBinding implements ViewBinding {
  ...
  @NonNull
  public final LinearLayout rowChat;
  ...
  public static FragmentAccountBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.row_chat;
      LinearLayout rowChat = ViewBindings.findChildViewById(rootView, id);
      if (rowChat == null) {
        break missingId;
      }
      ...
      id = R.id.row_my_orders;
      LinearLayout rowMyOrders = ViewBindings.findChildViewById(rootView, id);
      if (rowMyOrders == null) {
        break missingId;
      }
