...
public class RecipeSeeder implements CommandLineRunner {
    ...
    private void seedRecipes() throws JsonProcessingException {
        ...
        r.setDescription("Món Rau muống xào tỏi thơm ngon, xanh mướt giòn rụm. Phù hợp cho những bữa cơm gia đình ấm cúng, cung cấp đầy đủ dinh dưỡng và rất đưa cơm.");
        ...
        r = new Recipe();
        r.setId("recipe_005");
        r.setName("Khoai tây chiên giòn");
        r.setDescription("Khoai tây chiên giòn rụm, vàng ươm, thơm lừng. Phù hợp làm món ăn vặt hoặc ăn kèm các món chính.");
        r.setCategory("Món mặn");
        r.setPrepTime("10 phút");
        r.setCookTime("20 phút");
        r.setDifficulty("Trung bình");
        ...
        r = new Recipe();
        r.setId("recipe_007");
        r.setName("Salad rau củ tươi");
        r.setDescription("Món Salad rau trộn tươi mát, thanh đạm, tốt sức khỏe và dễ dàng chuẩn bị.");
        ...
        r = new Recipe();
        r.setId("recipe_008");
        r.setName("Canh bầu nấu tôm");
        r.setDescription("Canh bầu nấu tôm ngọt thanh mát, giải nhiệt mùa hè cực kỳ phù hợp cho bữa cơm gia đình.");
        r.setCategory("Món canh");
        r.setPrepTime("10 phút");
